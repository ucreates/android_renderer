...
public class TextureAtlasAnimatorAsset extends BaseAnimatorAsset {
    private BaseAsset textureAtlasAsset;
    private ArrayList<FloatBuffer> animationFrameUVs = new ArrayList<FloatBuffer>();
    public void setTextureAtlas(BaseAsset asset) {
        this.textureAtlasAsset = asset;
        return;
    }
    public void addFrameUVs(float[] uvs) {
        FloatBuffer tmpUVs = Allocator.allocateFloat(uvs.length);
