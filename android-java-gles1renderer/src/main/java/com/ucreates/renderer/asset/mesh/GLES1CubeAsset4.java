...
public class GLES1CubeAsset4 extends GLES1BaseAsset {
    public GLES1CubeAsset4(float width, float height, float depth, GLES1Color color) {
        this.width = width;
        this.height = height;
        this.depth = depth;
        this.color = color;
    ...
    public void create() {
        ...
        int vertexNomalsMemsize = normalsLength * GLES1Allocator.GL_FLOAT_SIZE;
        int surfaceNormalsMemsize = normalsLength * GLES1Allocator.GL_VECTOR3_SIZE;
    ...
    public void create(String texturePath, Context context) {
        ...
        int surfaceNomalsLength = normalsLength / GLES1Renderer.DIMENSION3D;
        int vertexNomalsMemsize = normalsLength * GLES1Allocator.GL_FLOAT_SIZE;
        int surfaceNormalsMemsize = surfaceNomalsLength * GLES1Allocator.GL_VECTOR3_SIZE;
        float[] vertexNormals = new float[vertexNomalsMemsize];
        Float3[] surfaceNormals = new Float3[surfaceNormalsMemsize];
        int vnidx = 0;
        int iidx1 = 0;
