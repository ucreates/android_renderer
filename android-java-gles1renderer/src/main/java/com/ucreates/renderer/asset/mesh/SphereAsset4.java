...
public class SphereAsset4 extends BaseAsset {
    private int divideCount;
    private float radius;
    public SphereAsset4(float radius, int divideCount, GLESColor color) {
        this.radius = radius;
        this.color = color;
    ...
    public void create() {
        ...
        int surfaceNormalsMemsize = surfaceNormalsLength * Allocator.GL_VECTOR3_SIZE;
        int indiciesMemsize = indiciesLength * Allocator.GL_SHORT_SIZE;
