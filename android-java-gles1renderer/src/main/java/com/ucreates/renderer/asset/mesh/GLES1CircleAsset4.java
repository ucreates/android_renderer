...
public class GLES1CircleAsset4 extends GLES1BaseAsset {
    private int divideCount;
    private float radius;
    public GLES1CircleAsset4(float radius, int divideCount, GLES1Color color) {
        this.radius = radius;
        this.color = color;
    ...
    public void create() {
        ...
        for (int i = 0; i < indiciesLength; i += 3) {
            indicies[i] = 0;
            indicies[i + 1] = (short) currentIndex;
