...
public class GLES1CircleAsset2 extends GLES1BaseAsset {
    private int divideCount;
    private float radius;
    public GLES1CircleAsset2(float radius, int divideCount, GLES1Color color) {
        this.radius = radius;
        this.color = color;
    ...
    public void create() {
        ...
        int indiciesMemsize = indiciesLength * GLES1Allocator.GL_FLOAT_SIZE;
