...
public class GLES1CircleAsset3 extends GLES1BaseAsset {
    private int divideCount;
    private float radius;
    public GLES1CircleAsset3(float radius, int divideCount, GLES1Color color) {
        this.radius = radius;
        this.color = color;
    ...
    public void create(String texturePath, int textureUnit, Context context) {
        ...
        int colorsLength = vertexCount * GLES1Renderer.RGBA;
        int colorsMemsize = colorsLength * GLES1Allocator.GL_FLOAT_SIZE;
        int uvMemsize = verticesLength * GLES1Allocator.GL_FLOAT_SIZE;
        float[] vertices = new float[vertexMemsize];
        float[] colors = new float[colorsMemsize];
