...
public class GLES1Allocator {
    ...
    public static FloatBuffer allocateFloat(int length) {
        return GLES1Allocator.allocate(length * GLES1Allocator.GL_FLOAT_SIZE).asFloatBuffer();
    }
    public static ShortBuffer allocateShort(int length) {
        return GLES1Allocator.allocate(length * GLES1Allocator.GL_SHORT_SIZE).asShortBuffer();
    }
}