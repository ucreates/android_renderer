...
public class GLES2Allocator {
    ...
    public static FloatBuffer allocateFloat(int length) {
        return GLES2Allocator.allocate(length * GLES2Allocator.GL_FLOAT_SIZE).asFloatBuffer();
    }
    public static ShortBuffer allocateShort(int length) {
        return GLES2Allocator.allocate(length * GLES2Allocator.GL_SHORT_SIZE).asShortBuffer();
    }
}